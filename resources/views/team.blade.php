...
<title>Team | Luxen Premium Hotel Template</title>
			...
			<div class="row">
				<div class="about-services margint40 clearfix"><!-- Team Section -->
					<div class="col-lg-3 col-sm-3">
						<img alt="Team Image" class="img-responsive" src="temp/otel-info-image-2.jpg" >
						<h5 class="margint10">Cersei Lannister</h5>
						<p class="margint10">Duis mollis, est non commodo luctus, nisi erat odio sewd euismod semp. </p>
					...
					<div class="col-lg-3 col-sm-3">
						<img alt="Team Image" class="img-responsive" src="temp/otel-info-image-3.jpg" >
						<h5 class="margint10">Tyrion Lannister</h5>
						<p class="margint10">Duis mollis, est non commodo luctus, nisi erat odio sewd euismod semp. </p>
						<ul class="social-links">
							<li><a href="http://facebook.com/2035themes"><i class="fa fa-facebook"></i></a></li>
							<li><a href="http://twitter.com/2035themes"><i class="fa fa-twitter"></i></a></li>
					...
					<div class="col-lg-3 col-sm-3">
						<img alt="Team Image" class="img-responsive" src="temp/otel-info-image-4.jpg" >
						<h5 class="margint10">Jon Snow</h5>
						<p class="margint10">Duis mollis, est non commodo luctus, nisi erat odio sewd euismod semp. </p>
						<ul class="social-links">
							<li><a href="http://facebook.com/2035themes"><i class="fa fa-facebook"></i></a></li>
							<li><a href="http://twitter.com/2035themes"><i class="fa fa-twitter"></i></a></li>
					...
					<div class="col-lg-3 col-sm-3">
						<img alt="Team Image" class="img-responsive" src="temp/otel-info-image-1.jpg" >
						<h5 class="margint10">Jorah Mormont</h5>
						<p class="margint10">Duis mollis, est non commodo luctus, nisi erat odio sewd euismod semp. </p>
						<ul class="social-links">
							<li><a href="http://facebook.com/2035themes"><i class="fa fa-facebook"></i></a></li>
							<li><a href="http://twitter.com/2035themes"><i class="fa fa-twitter"></i></a></li>
