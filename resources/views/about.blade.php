							...
							<nav class="nav">
								<ul id="navigate" class="sf-menu navigate">
									<li class="parent-menu"><a href="{{url('/index')}}">HOMEPAGE</a>
										<ul>
											<li><a href="{{url('/index')}}">Slider Homepage</a></li>
				...
				<div class="about-slider margint40"><!-- About Slider -->
					<div class="col-lg-12">
						<div class="flexslider">
							<ul class="slides">
								<li><img alt="Slider 1" class="img-responsive" src="temp/slider-1.jpg" /></li>
								<li><img alt="Slider 1" class="img-responsive" src="temp/slider-2.jpg" /></li>
								<li><img alt="Slider 3" class="img-responsive" src="temp/slider-3.jpg" /></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-10 col-sm-10">
						...
						<div class="col-lg-3 col-sm-3">
							...
							<ul class="footer-links">
								...
								<li><a href="blog-details.html">Blog Single</a></li>
								<li><a href="{{url('/category-grid')}}">Category Grid</a></li>
